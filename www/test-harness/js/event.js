$(_ => {
  ...
  $('body>.main>.workspace>.template>.notes')
    .clone(true, true)
    .insertAfter($('body>.main>.workspace>.template>.table.events>.rows'))

  let $genphotos = $('body>.main>.workspace>.template>.photos')
    .clone(true, true)
    .insertAfter($('body>.main>.workspace>.template>.table.events>.rows'))

  $('body>.main>.workspace .table.events>.rows').off('send')
    .on('send', (e, ...data) => {
